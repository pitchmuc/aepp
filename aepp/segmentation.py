...
class Segmentation:
    ...
    def __str__(self):
        return json.dumps({'class':'Segmentation','sandbox':self.sandbox,'clientId':self.connector.config.get("client_id"),'orgId':self.connector.config.get("org_id")},indent=2)
