...
- [Catalog module in aepp](#catalog-module-in-aepp)
  ...
  - [The Catalog class](#the-catalog-class)
    - [The Catalog class attributes](#the-catalog-class-attributes)
      - [The data attributes](#the-data-attributes)
  - [Catalog methods](#catalog-methods)
      - [getResource](#getresource)
      - [getResourceToFile](#getresourcetofile)
      - [decodeStreamBatch](#decodestreambatch)
      - [jsonStreamMessages](#jsonstreammessages)
      - [getLastBatches](#getlastbatches)
      - [getBatches](#getbatches)
      - [getFailedBatchesDF](#getfailedbatchesdf)
      - [getBatch](#getbatch)
      - [createBatch](#createbatch)
      - [getResources](#getresources)
      - [getDataSets](#getdatasets)
      - [patchDataset](#patchdataset)
      - [patchDatasetV2](#patchdatasetv2)
      - [putDataset](#putdataset)
      - [getProfileSnapshotDatasets](#getprofilesnapshotdatasets)
      - [getDatasetsInfos](#getdatasetsinfos)
      - [createDataSets](#createdatasets)
      - [getDataSet](#getdataset)
      - [getDataSetObservableSchema](#getdatasetobservableschema)
      - [deleteDataSet](#deletedataset)
      - [getDataSetViews](#getdatasetviews)
      - [getDataSetView](#getdatasetview)
      - [getDataSetViewFiles](#getdatasetviewfiles)
      - [enableDatasetProfile](#enabledatasetprofile)
      - [enableDatasetIdentity](#enabledatasetidentity)
      - [enableDatasetUpsert](#enabledatasetupsert)
      - [disableDatasetProfile](#disabledatasetprofile)
      - [disableDatasetIdentity](#disabledatasetidentity)
      - [createUnionProfileDataset](#createunionprofiledataset)
      - [getMapperErrors](#getmappererrors)
      - [findActiveBatch](#findactivebatch)
  - [Observable Schema Manager](#observable-schema-manager)
    ...
    - [Observable Schema Manager Methods](#observable-schema-manager-methods)
      ...
      - [to\_dict](#to_dict)
      - [compareSchemaAvailability](#compareschemaavailability)
  - [Catalog use-cases](#catalog-use-cases)
    - [Listing the current datasets](#listing-the-current-datasets)
    - [The data attribute](#the-data-attribute)
    - [Monitor batch ingestion](#monitor-batch-ingestion)
    - [Retrieve failed batches as DataFrame](#retrieve-failed-batches-as-dataframe)
